...
warnbox   & \textcolor{warnred}{Red}                  & Warnings; important notices \\
flowbox   & \textcolor{orange!65!black}{Dark orange}  & Key formulae; summary boxes \\
...
\begin{tipbox}[Remark --- Primary References]
K.\ Hoffman and R.\ Kunze, \textit{Linear Algebra}, 2nd ed.\ (Prentice Hall).\\
Blackboard notes by \textbf{Cristian Chaparro} from the \textit{Algebra~1/Extended} course at GTIIT.\\
These notes follow the lecture structure and are not tied to any particular chapter ordering of the textbook.
\end{tipbox}
